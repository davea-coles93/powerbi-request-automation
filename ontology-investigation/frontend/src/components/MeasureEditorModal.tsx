...
export function MeasureEditorModal({
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={measure ? 'Edit Measure' : 'Create New Measure'}
      subtitle="Define a calculation or derivation from attributes"
      maxWidth="4xl"
    >
      <form onSubmit={handleSubmit}>
        <div className="p-6 space-y-6">
          ...
          <div className="border-t px-6 py-4 flex justify-end gap-3">
            ...
            <ModalSubmitButton>Save Measure</ModalSubmitButton>
          </div>
        </form>
    </Modal>
  );
